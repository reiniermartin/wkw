...
var Game = {
    ...
    update: function () {
        if (!this.over) {
            ...
            if (Pong._turnDelayIsOver.call(this) && this.turn) {
                ...
                // Adjust the starting x-coordinate based on the direction
                if (this.ball.moveX === DIRECTION.LEFT) {
                    this.ball.x = this.canvas.width / 2 + 100; // +50 on the x-axis for DIRECTION.LEFT
                } else {
                    this.ball.x = this.canvas.width / 2 - 100; // -50 on the x-axis for DIRECTION.RIGHT
                }
    ...
    draw: function () {
        ...
        var scorePlayer = document.getElementById('pongScorePlayer'),
            scoreComputer = document.getElementById('pongScoreAI'),
            gameLevel = document.getElementById('pongLevel'),
            gameLevelPoints = document.getElementById('pongLevelPoints');
