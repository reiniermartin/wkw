...
var rounds = [10];
//var colors = ['#1C1C1C', '#1C1C1C', '#1C1C1C', '#1C1C1C', '#1C1C1C'];
...
var Game = {
    ...
    update: function () {
        if (!this.over) {
            ...
            if (Pong._turnDelayIsOver.call(this) && this.turn) {
                ...
                this.ball.y = Math.floor(Math.random() * this.canvas.height - 200) + 10;
                this.turn = null;
            }
    ...
    draw: function () {
        ...
        this.context.strokeRect(450, 200, this.canvas.width - 900, this.canvas.height - 400);

        this.context.strokeStyle = '#E8B62A';
        this.context.lineWidth = 2;
        this.context.strokeRect(0, 0, this.canvas.width - 1, this.canvas.height);
